...
namespace Eco.Mods.TechTree
{
    ...
    public partial class FenceGateCenterAltObject : DoorObject, IRepresentsItem
    {
        [Serialized] public bool Door = true;
        public override LocString DisplayName { get { return Localizer.DoStr("Chainlink Gate Center Right"); } }
        public override TableTextureMode TableTexture => TableTextureMode.Stone;
        public virtual Type RepresentedItemType { get { return typeof(FenceGateCenterAltItem); } }
    ...
    [Serialized]
    [LocDisplayName("Chainlink Gate Center Right")]
    [Tier(4)]
    [Ecopedia("Housing Objects", "Doors", createAsSubPage: true)]
    public partial class FenceGateCenterAltItem : WorldObjectItem<FenceGateCenterAltObject>
    {
        ...
        public override string OnUsed(Player player, ItemStack itemStack)
        {
            ...
            if (user.Inventory.TryRemoveItem<FenceGateCenterAltItem>(user))
            {
                user.Inventory.TryAddItem<FenceGateCenterItem>(user);
